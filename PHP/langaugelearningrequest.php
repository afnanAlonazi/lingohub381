...
<!--Posting language learning request
Author:renad-->
...
<div id="request-Post-box">
    ...
    <form method="post" ><!--will be sent to be proccesed later on -->
    ...
    <input type="datetime-local" id="Date" name="schedule" required>
    ...
    <!--we should add a conformition box later on maybe its done with java script-->
